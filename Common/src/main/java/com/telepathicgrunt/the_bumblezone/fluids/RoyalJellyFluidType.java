...
public class RoyalJellyFluidType extends FluidType {
    public static final ResourceLocation ROYAL_JELLY_FLUID_STILL_TEXTURE = new ResourceLocation(BumblezoneCommon.MODID, "block/royal_jelly_fluid_still");
    public static final ResourceLocation ROYAL_JELLY_FLUID_FLOWING_TEXTURE = new ResourceLocation(BumblezoneCommon.MODID, "block/royal_jelly_fluid_flow");
