...
public class SugarWaterFluidType extends FluidType {
    public static final ResourceLocation FLUID_STILL_TEXTURE = new ResourceLocation(BumblezoneCommon.MODID, "block/sugar_water_still");
    public static final ResourceLocation FLUID_FLOWING_TEXTURE = new ResourceLocation(BumblezoneCommon.MODID, "block/sugar_water_flow");
    public static final ResourceLocation FLUID_OVERLAY_TEXTURE = new ResourceLocation(BumblezoneCommon.MODID, "block/sugar_water_overlay");
