...
public class HoneyFluidType extends FluidType {
    public static final ResourceLocation HONEY_FLUID_STILL_TEXTURE = new ResourceLocation(BumblezoneCommon.MODID, "block/honey_fluid_still");
    public static final ResourceLocation HONEY_FLUID_FLOWING_TEXTURE = new ResourceLocation(BumblezoneCommon.MODID, "block/honey_fluid_flow");
