...
public class BzSounds {
    public static final RegistrationProvider<SoundEvent> SOUND_EVENTS = RegistrationProvider.get(Registry.SOUND_EVENT_REGISTRY, BumblezoneCommon.MODID);
    ...
    private static RegistryObject<SoundEvent> registerSoundEvent(String path) {
        return SOUND_EVENTS.register(path, () -> new SoundEvent(new ResourceLocation(BumblezoneCommon.MODID, path)));
    }
}
