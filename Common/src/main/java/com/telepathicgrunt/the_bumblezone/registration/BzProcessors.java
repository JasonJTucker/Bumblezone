...
public class BzProcessors {
    public static final RegistrationProvider<StructureProcessorType<?>> STRUCTURE_PROCESSOR = RegistrationProvider.get(Registry.STRUCTURE_PROCESSOR_REGISTRY, BumblezoneCommon.MODID);
