...
public class BzPredicates {
    ...
    public static void registerPredicates() {
        Registry.register(Registry.POS_RULE_TEST, new ResourceLocation(BumblezoneCommon.MODID, "piece_origin_axis_aligned_linear_pos_rule_test"), PIECE_ORIGIN_AXIS_ALIGNED_LINEAR_POS_RULE_TEST);
    }
}
